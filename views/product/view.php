                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12 product-viewer clearfix">
                        ...
                        <div id="product-image-container">
                            <figure><img src="/template/images/products/big-item1.jpg"
                                         data-zoom-image="template/images/products/big-item1.jpg"
                                         alt="Product Big image" id="product-image">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12 product">
                        ...
                        <ul class="product-list">
                            <li><span>Описание:</span>
                                <p><?php echo $product['description']; ?></p></li>
                            <li><span>Бренд:</span>
                                <p><?php echo $product['brand']; ?></p></li>
                            <li><span>Код товара:</span><?php echo $product['code']; ?></li>
                        </ul>
                        <hr>

                        <div class="product-add clearfix">

                            <button class="btn btn-custom-2">Купить</button>
                        </div><!-- .product-add -->
