                    ...
                    <form action="#" method="post" id="register-form">
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <fieldset>
                                    <h2 class="sub-title">Введите персональные данные</h2>
                                    <p>Установите галочку под основным E-Mail адресом</p>
                                    <?php if ($result): ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <input type="submit" name="submit" class="btn btn-custom-2" value="Регистрация"/>
                                    <?php endif; ?>
                                </fieldset>
                            </div><!-- End .col-md-6 -->
                        </div><!-- End .row -->
